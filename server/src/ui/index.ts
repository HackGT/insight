namespace Index {
  class SponsorModalManager {
    ...
    private readonly eventInformation = document.getElementById(
      "company-eventInformation"
    ) as HTMLElement;

    private readonly challengeInformation = document.getElementById(
      "company-challengeInformation"
    ) as HTMLElement;

    private readonly recruiting = document.getElementById("company-recruiting") as HTMLElement;
    private readonly additionalInfo = document.getElementById(
      "company-additionalInfo"
    ) as HTMLElement;

    private readonly participantLink = document.getElementById(
      "company-participantLink"
  ...
  const sponsorView = document.getElementById("sponsor-content");
